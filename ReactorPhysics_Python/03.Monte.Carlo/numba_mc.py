...
def main():
    ...
    pitch = 3.65  # cm           # INPUT Default: 3.6 cm

    # Define fuel and coolant regions
    #fuelLeft, fuelRight = 0.9, 2.7  # INPUT (Default)
    #coolLeft, coolRight = 0.7, 2.9  # INPUT (Default)

    fuelLeft, fuelRight = 0.9, 2.7  # INPUT
    coolLeft, coolRight = 0.5, 3.1  # INPUT
