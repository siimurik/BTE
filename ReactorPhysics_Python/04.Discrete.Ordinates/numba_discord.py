...
def getLebedevReccurencePoints(type, start, a, b, v, leb):
    ...
    if type == 1:
        ...
        #%/* In this elif degree == A is inputed */
        ...
        #%/* A is inputed in this elif degree == as well*/
        b = np.sqrt(1-a*a)
        leb["x"][start] = a
        leb["y"][start] = b
        leb["z"][start] = 0.0
        ...
        #%/* both A and B are inputed in this elif degree == */
...
def getLebedevSphere(degree):
    ...
    if degree == 6:
        ...
        raise ValueError('Angular grid unrecognized, choices are 6, 14, 26, 38, 50, 74, 86, 110, 146, 170, 194, 230, 266, 302, 350, 434, 590, 770, 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, 3470, 3890, 4334, 4802, 5294, 5810')
